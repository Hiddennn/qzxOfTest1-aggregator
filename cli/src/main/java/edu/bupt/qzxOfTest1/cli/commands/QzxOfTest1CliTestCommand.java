 ...
 */
package edu.bupt.qzxOfTest1.cli.commands;
...
public class QzxOfTest1CliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(QzxOfTest1CliTestCommand.class);
    protected final QzxOfTest1CliCommands service;

    public QzxOfTest1CliTestCommand(final QzxOfTest1CliCommands service) {
